...
export default function DriverLoginPage() {
  ...
  const handleAuthSuccess = (data: any) => {
    if (data.user.role !== 'DRIVER') {
      setError('Acesso negado. Esta área é exclusiva para entregadores. Cadastre-se primeiro.');
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Portal do Entregador</h1>
          <p className="text-green-100 mt-2">Faça entregas e ganhe dinheiro</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              Quer ser um entregador?{' '}
              <Link href="/driver/register" className="text-green-600 hover:underline font-medium">
                Cadastre-se aqui
              </Link>
            </p>
          </div>
